...
export default [
  ...
  // },
  {
    ...
    preview: './img/ondemand.png',
    // screenshots: [],
    tags: [skill.vue3, skill.unoCss, skill.storybook, skill.js],
    description: [
      '[blockquote](TeamUp is a fitness management software designed to empower service providers in franchises, studios, gyms, and boxes.)',
    ],
    features: [
      [
  ...
  },
  {
    ...
    description: [
      '[blockquote](Enovational is a data-driven web and app development company that span a wide spectrum of audiences, technologies, and platforms, from consumer facing mobile apps to large government and enterprise custom web applications.)',
    ],
    featuresList: [
      'No-code platform.',
      ...
      'Ensure compliance with 508 and WCAG2 accessibility standards.',
    ],
    link: {
